...
export const PIPELINE_MODES = {
  all: {
    ...
    name: 'Full Analysis',
    description:
      'Complete pipeline: detection, tracking, team classification, pitch mapping, and analytics',
...
export const EVENT_TYPES = {
  ...
  play: { name: 'Open Play', color: '#10b981', icon: 'Play' },
  throwin: { name: 'Throw-in', color: '#6366f1', icon: 'Hand' },
} as const
