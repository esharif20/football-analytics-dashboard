...
export function PitchRadar({ data, selectedPlayer }: { data: any; selectedPlayer?: number | null }) {
...
// Premium Player Node
export function PlayerNode({ player, teamId, isSelected }: { player: any; teamId: number; isSelected?: boolean }) {
  const { TEAM1_HEX, TEAM2_HEX } = useTeamColors();
